...
// Используется Signals.rc
//
#define IDD_SIGNALS_DIALOG              102
#define IDR_MAINFRAME                   128
#define IDC_SIGNAL1                     1000
