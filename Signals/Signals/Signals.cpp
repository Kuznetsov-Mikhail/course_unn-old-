...
BEGIN_MESSAGE_MAP(CSignalsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSignalsApp

CSignalsApp::CSignalsApp()
{
...
// Единственный объект CSignalsApp

CSignalsApp theApp;


// Инициализация CSignalsApp

BOOL CSignalsApp::InitInstance()
{
