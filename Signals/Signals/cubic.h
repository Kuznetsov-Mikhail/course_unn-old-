...
namespace
{
    ...
    namespace tk
    {
        ...
        public:
            ...
            vector<double> lu_solve(const vector<double>& b,
        ...
        public:
            ...
            void set_points(const vector<double>& x,
                const vector<double>& y, bool cubic_spline = true);
        ...
        vector<double> band_matrix::lu_solve(const vector<double>& b,
        ...
        void spline::set_points(const vector<double>& x,
            const vector<double>& y, bool cubic_spline)
        {
